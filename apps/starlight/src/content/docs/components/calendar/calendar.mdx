...
<Types
	types={[
		{
			name: 'LocaleCalendar',
			type: "'buddhist' | 'chinese' | 'coptic' | 'dangi' | 'ethioaa' | 'ethiopic' | 'gregory' | 'hebrew' | 'indian' | 'islamic' | 'islamic-umalqura' | 'islamic-tbla' | 'islamic-civil' | 'islamic-rgsa' | 'iso8601' | 'japanese' | 'persian' | 'roc' | 'islamicc'"
		},
		{
			name: 'CalendarSelect',
			type: "'one' | 'many' | 'range'"
		...
		{
			name: 'CalendarSelectValue',
			type: 'null | PlainDate | PlainDate[] | PlainDateRange'
		},
		{
		...
		{
			name: 'CalendarVisibleDuration',
			type: '{ months: number }'
		},
		{
			name: 'CalendarCellType',
			type: "'week' | 'weekday' | 'day' | 'blank'"
		},
		{
			name: 'CalendarGridCellItem',
			type: '{ type: CalendarCellType, date: PlainDate }'
		}
	]}
/>
